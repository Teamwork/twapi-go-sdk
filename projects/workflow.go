...
//
// https://apidocs.teamwork.com/docs/teamwork/v3/workflows/patch-projects-api-v3-workflows-id-json
...
//
// https://apidocs.teamwork.com/docs/teamwork/v3/workflows/delete-projects-api-v3-workflows-id-json
...
type WorkflowListRequestFilters struct {
	...
	// CountMode selects whether the API computes the exact number of workflows
